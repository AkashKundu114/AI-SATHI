...
@pytest.mark.asyncio
async def test_leaked_secret_in_model_reply_is_replaced_with_canned_fallback(monkeypatch):
    async def _fake(**kwargs):
        return {"text": "here's a key sk-abcdefghijklmnopqrstuvwxyz123456", "model_used": "sarvam-standard", "escalated": False}
...
async def test_url_in_model_reply_is_replaced_with_canned_fallback(monkeypatch):
    async def _fake(**kwargs):
        return {"text": "দেখুন https://example.com/details", "model_used": "sarvam-standard", "escalated": False}
