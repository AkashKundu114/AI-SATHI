...
def generate_upi_payment_link(upi_id: str, payee_name: str, amount_inr: float, note: str = "Baki Payment") -> str:
    """Generates a standard UPI deep-link for instant payment via GPay / PhonePe / Paytm."""
    if not upi_id:
        return ""
...
def format_baki_reminder_message(
    ...
    """
    Formats a dignified, respectful Bengali customer reminder message for pending credit/baki.
    Avoids harsh or shaming tone, focusing on relationship and mutual trust.
    """
