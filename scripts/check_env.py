...
def main(quiet: bool = False) -> int:
    ...
    # --- Sarvam / local-model fallback tier ---
    ...
    # --- Bengali font / poster generation ---
    ...
    # --- Webhook secret / verify token confusion guard (red-team HIGH-1) ---
    ...
    # --- Message/rate-limit config sanity ---
    try:
