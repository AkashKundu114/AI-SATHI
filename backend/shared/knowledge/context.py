...
LIFE_EVENTS: list[LifeEvent] = [
    LifeEvent(
        "mukhe_bhaat",
        "মুখেভাত / অন্নপ্রাশন",
        "First rice ceremony (Annaprashan)",
        "hindu_bengali",
        "birth",
    ...
    LifeEvent(
        "aqiqah",
        "আকিকা",
        "Aqiqah (newborn naming / first hair-cutting rite)",
        "muslim_bengali",
        "birth",
    ...
    LifeEvent(
        "aiburo_bhaat",
        "আইবুড়ো ভাত",
        "Pre-wedding farewell rice meal (bride/groom's last meal as unmarried)",
        "hindu_bengali",
        "wedding",
        typical_spend_categories=["food"],
    ...
    LifeEvent(
        "nikah",
        "নিকাহ",
        "Nikah (Islamic marriage contract ceremony -- Mahr agreed, witnessed, Nikahnama signed)",
        "muslim_bengali",
        "wedding",
    ...
    LifeEvent(
        "walima",
        "ওলিমা",
        "Walima (groom's-family wedding reception, sometimes called Bou Bhaat in Bengali usage)",
        "muslim_bengali",
        "wedding",
        typical_spend_categories=["food", "textile"],
    ...
    LifeEvent(
        "bou_bhaat",
        "বৌভাত",
        "Reception where the bride formally serves rice to the groom's family",
        "hindu_bengali",
        "wedding",
        typical_spend_categories=["food", "textile"],
    ...
    LifeEvent(
        "sasthi_puja",
        "ষষ্ঠী পূজা",
        "Sasthi puja (child-protection / fertility rites, several forms through the year)",
        "hindu_bengali",
        "religious",
    ...
    LifeEvent(
        "shraddha",
        "শ্রাদ্ধ",
        "Memorial rite for a deceased family member",
        "hindu_bengali",
        "death",
        typical_spend_categories=["food"],
    ...
    LifeEvent(
        "christian_bengali_wedding",
        "খ্রিস্টান বিয়ে",
        "Bengali Christian church wedding",
        "christian_bengali",
        "wedding",
        typical_spend_categories=["textile", "food"],
        demand_note_bengali="নতুন পোশাক ও অনুষ্ঠানের খাবারের চাহিদা বাড়ে।",
    ...
    LifeEvent(
        "christian_bengali_baptism",
        "খ্রিস্টীয় দীক্ষাস্নান (ব্যাপ্টিজম)",
        "Baptism / christening",
        "christian_bengali",
        "birth",
        typical_spend_categories=["food", "textile"],
    ...
    LifeEvent(
        "christian_bengali_funeral_prayer",
        "প্রার্থনা সভা (খ্রিস্টীয় শেষকৃত্য)",
        "Christian funeral / memorial prayer service",
        "christian_bengali",
        "death",
        typical_spend_categories=["food"],
...
FESTIVALS: list[Festival] = [
    Festival(
        ...
        "Bengali New Year",
        [4],
        ["food", "handicraft", "textile"],
        "নতুন বছরের কেনাকাটা ও মিষ্টির চাহিদা বাড়ে।",
    ),
    ...
    Festival(
        ...
        [1, 2],
        ["food", "handicraft"],
        "ফল, মিষ্টি ও পূজার সামগ্রীর চাহিদা বাড়ে।",
    ),
    Festival(
        "durga_puja",
        "দুর্গা পূজা",
        "Durga Puja",
        [9, 10],
        ["textile", "food", "handicraft"],
        "সবচেয়ে বড় মরসুম -- শাড়ি, নতুন পোশাক, মিষ্টির চাহিদা তুঙ্গে থাকে।",
    ),
    Festival(
        "kali_puja",
        "কালী পূজা / দীপাবলি",
        ...
        [10, 11],
        ["food", "handicraft"],
        "মোমবাতি, প্রদীপ ও মিষ্টির চাহিদা বাড়ে।",
    ),
    Festival(
        "jagadhatri_puja",
        "জগদ্ধাত্রী পূজা",
        ...
        [11],
        ["food", "handicraft"],
        "স্থানীয়ভাবে (বিশেষত চন্দননগর) চাহিদা বাড়ে।",
    ),
    Festival(
        "nabanna", "নবান্ন", "Nabanna (new-harvest rice festival)", [11, 12], ["food"], "নতুন চালের পিঠা ও মিষ্টির চাহিদা বাড়ে।"
    ),
    Festival(
        "poush_mela",
        "পৌষ মেলা",
        ...
        [12],
        ["handicraft", "food"],
        "হস্তশিল্প ও পিঠার মেলা -- গ্রামীণ কারুশিল্পের চাহিদা বাড়ে।",
    ),
    Festival("christmas", "বড়দিন", "Christmas", [12], ["food", "handicraft"], "কেক ও উপহারের চাহিদা বাড়ে, বিশেষত শহরাঞ্চলে।"),
    Festival(
        "eid_ul_fitr",
        "ঈদ-উল-ফিতর",
        "Eid ul-Fitr",
        [3, 4, 5],
        ["food", "textile"],
        "নতুন পোশাক ও মিষ্টির চাহিদা বাড়ে। (চান্দ্র ক্যালেন্ডার -- তারিখ প্রতি বছর বদলায়)",
    ),
    Festival(
        "eid_ul_adha",
        "ঈদ-উল-আযহা / বকরি ঈদ",
        ...
        [6, 7, 8],
        ["food"],
        "মাংসের চাহিদা বাড়ে। (চান্দ্র ক্যালেন্ডার -- তারিখ প্রতি বছর বদলায়)",
    ),
]
...
SEASONAL_PATTERNS: list[SeasonalPricePattern] = [
    ...
    SeasonalPricePattern(
        "শরৎ-হেমন্ত (অক্টোবর-নভেম্বর)",
        [10, 11],
        "পূজার মরসুম, আবহাওয়া মনোরম -- বিক্রির সেরা সময়।",
        ["টেক্সটাইল ও হস্তশিল্পের চাহিদা তুঙ্গে (দুর্গা পূজা, কালী পূজা)", "নতুন ধান ওঠে -- চাল ও চালজাত পণ্যের সরবরাহ বাড়ে"],
    ),
    SeasonalPricePattern(
    ...
    SeasonalPricePattern(
        ...
        ["সরস্বতী পূজার সামগ্রীর চাহিদা (ফেব্রুয়ারি থেকে চলতে থাকে)", "গ্রীষ্মের আগে হালকা সুতির কাপড়ের চাহিদা বাড়তে শুরু করে"],
    ),
]
...
DISTRICT_MELAS: list[DistrictMela] = [
    DistrictMela(
        ...
        [1],
        ["food", "handicraft"],
        "মকর সংক্রান্তির সময় (মধ্য জানুয়ারি) সাগরদ্বীপে লক্ষ লক্ষ তীর্থযাত্রীর সমাগম হয় -- খাবার ও ধর্মীয় সামগ্রীর চাহিদা তুঙ্গে থাকে।",
    ...
    DistrictMela(
        "joydev_kenduli_mela",
        "জয়দেব কেন্দুলি মেলা / বাউল মেলা",
        "Joydev Kenduli Mela (Baul Mela)",
        "Birbhum",
        [1],
        ["handicraft", "food"],
...
def get_context_for_agents(month: int, block: str | None = None, district: str | None = None) -> dict:
    ...
    return {
        ...
        "upcoming_festivals": [
            {
                "slug": f.slug,
                "name_bengali": f.name_bengali,
                "demand_categories": f.demand_categories,
        ...
        "upcoming_district_melas": [
            {
                "slug": m.slug,
                "name_bengali": m.name_bengali,
                "district": m.district,
                "demand_categories": m.demand_categories,
                "note": m.demand_note_bengali,
            }
        ...
        if season is None
            ...
            "name": season.season_bengali,
            "weather_note": season.weather_note_bengali,
