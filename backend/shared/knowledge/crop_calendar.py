...
CROP_CALENDAR: list[CropSeason] = [
    CropSeason(
        "aman_paddy",
        "আমন ধান",
        "Aman paddy (main monsoon-season rice)",
        ["Nadia", "Bardhaman", "Birbhum", "Hooghly"],
        sowing_months=[6, 7, 8],
        harvest_months=[11, 12],
        note_bengali="সবচেয়ে বড় ধানের ফসল -- নভেম্বর-ডিসেম্বরে কাটা হয়, তখন চালের দাম সাধারণত সবচেয়ে কম থাকে।",
    ...
    CropSeason(
        "boro_paddy",
        "বোরো ধান",
        "Boro paddy (irrigated winter/dry-season rice)",
        ["Bardhaman", "Birbhum"],
        sowing_months=[11, 12, 1],
        harvest_months=[4, 5],
    ...
    CropSeason(
        ...
        note_bengali="ভারতের পাটের প্রায় দুই-তৃতীয়াংশ পশ্চিমবঙ্গ থেকে আসে -- বর্ষায় কাটা ও জাগ দেওয়া হয়, তারপর সরবরাহ বাড়ে।",
    ...
    CropSeason(
        ...
        sowing_months=[10, 11],
        harvest_months=[2, 3],
        note_bengali="আমন ধান কাটার পর বোনা রবি শস্য -- ফেব্রুয়ারি-মার্চে ফসল ওঠে, তখন সরিষার তেলের কাঁচামাল সস্তা হতে পারে।",
