...
async def digitize_document (file_bytes :bytes ,filename :str ="document.pdf",language :str ="bn-IN",output_format :str ="md")->dict :
    """
    ...
    try :
        ...
        from sarvamai import SarvamAI 
        client =SarvamAI (api_subscription_key =s .sarvam_api_key )
        job =client .document_intelligence .create_job (language =language ,output_format ="html"if output_format =="html"else "markdown")
